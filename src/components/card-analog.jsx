...
class CardAnalog extends Component {
  constructor(props) {
    super(props);
  ...
  lastReadingAlert(analogValue) {
    return (analogValue > 300);
  }
        ...
        <div className={`card card-pointer blue-grey ${this.props.selected ? "darken-3" : "darken-4"}`} onClick={this.handleClick}>
          <div className={`card grey ${this.props.selected ? "darken-3" : "darken-4"}`}>
            <div className="card-content white-text">
              ...
              {this.lastReadingAlert() ? <span className="card-warning-icon"><i className="material-icons red-text">error</i></span> : null}
              <span className="card-title">{this.props.analogValue !== null || this.props.analogValue !== undefined ? formatNumberForLanguage(this.props.analogValue, navigator.language, 0) : "Error"}</span>
